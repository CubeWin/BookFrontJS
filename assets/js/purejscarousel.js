...
(function () {
        ...
        if ('ontouchstart' in window || navigator.maxTouchPoints) {
            ...
            _.slidesContainer.addEventListener('touchend', function () {
                var direction =
                    ...
                    blockWidth =
                        _.oneByOne === true
                            ? _.slidesContainer[0].offsetWidth
                ...
                if (
                    ...
                    if (_.infinite === true) {
                        ...
                        if (
                            ...
                            _.slidesContainer.style.marginLeft =
                                parseInt(
                                    this.getAttribute('data-start-margin')
                                ) + 'px';
                            if (
                                _.slidesContainer.style.transition ===
                                'undefined'
                    ...
                    _.slidesContainer.style.marginLeft =
                        parseInt(this.getAttribute('data-start-margin')) + 'px';
                    if (_.slidesContainer.style.transition === 'undefined') {
                        if (
                            _.slidesContainer.style.transition !== 'undefined'
                        ) {
                            _.slidesContainer.style.transition = null;
                        }
                    } else {
        ...
        if (_.infinite === true) {
            ...
            for (i = 0; i < _.slides.length; i++) {
                ...
                _.slidesContainer.insertBefore(
                    slideClone,
                    _.slidesContainer.querySelectorAll('.purejscarousel-slide')[
                        i
                    ]
                );
            }
    ...
    PureJSCarousel.prototype.goToNextSlide = function () {
        ...
        if (this.btnNext.disabled === false) {
            if (this.infinite === true) {
                newActiveIndex =
                    this.activeIndex + 1 > this.maxIndex
                        ? 0
                        : this.activeIndex + 1;
            } else {
    ...
    PureJSCarousel.prototype.goToSlide = function (n, dir, trigger) {
        ...
        function scrollEnd() {
            ...
            if ('transition' in document.body.style) {
                _.slidesContainer.style.transition = null;
                _.slidesContainer.removeEventListener(
                    'transitionend',
                    scrollEnd
                );
            }

            _.dots[_.activeIndex].className = _.dots[
                _.activeIndex
    ...
    PureJSCarousel.prototype.destroy = function () {
        ...
        if (this.isEnabled === 1) {
            ...
            if (
                this.btnNext.getAttribute('data-is-native').toString() === '1'
            ) {
            ...
            if (
                this.btnPrev.getAttribute('data-is-native').toString() === '1'
            ) {
